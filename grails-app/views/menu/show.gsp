	...
	<body>
		...
		<div id="show-menu" class="content scaffold-show" role="main">
			...
			<ol class="property-list menu">
				...
				<g:if test="${menuInstance?.price}">
				<li class="fieldcontain">
					<span id="price-label" class="property-label"><g:message code="menu.price.label" default="Price" /></span>
					
						<span class="property-value" aria-labelledby="price-label"><g:fieldValue bean="${menuInstance}" field="price"/></span>
